    ...
    if ($('#sales-statistics-overview').length) {
      ...
      var areaOptions = {
        ...
        legendCallback: function (chart) {
          var t = [];
          t.push('<div class="chartjs-legend"><ul>');
          for (var i = 0; i < chart.data.datasets.length; i++) {
            console.log(chart.data.datasets[i]); // see what's inside the obj.
            t.push('<li>');
            t.push('<span style="background-color:' + chart.data.datasets[i].borderColor + '">' + '</span>');
            t.push(chart.data.datasets[i].label);
            t.push('</li>');
          }
          t.push('</ul></div>');
          return t.join("");
      ...
      var chartOptions = {
        ...
        legendCallback: function (chart) {
          ...
          for (var i = 0; i < chart.data.datasets.length; i++) {
            console.log(chart.data.datasets[i]); // see what's inside the obj.
            t.push('<li>');
            t.push('<span style="background-color:' + chart.data.datasets[i].backgroundColor + '">' + '</span>');
            t.push(chart.data.datasets[i].label);
            t.push('</li>');
          }
          t.push('</ul></div>');
